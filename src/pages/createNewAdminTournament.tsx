...
const CreateNewAdminTournamant : React.FC = () => {
     ...
     return(
         <div className="w-full min-h-[100vh] h-full bg-[#0B0D13] py-[20px] px-[10px] md:py-[75px] md:px-[60px]">
             <section className="">
                 {/* upload file section */}
                 <div className="">
                     <h1 className="capitalize text-[#45F882] text-[2rem] md:text-[4rem] lg::text-[6rem] rajdhani-bold">create new Admin tournament</h1>
                 </div>
...
export default CreateNewAdminTournamant;