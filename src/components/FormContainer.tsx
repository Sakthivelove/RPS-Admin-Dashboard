...
import DynamicFormFields, { Field } from "./FormFields"; // Adjust the import if necessary
import Button from "./AdminButton"; // Assuming you have a reusable button component

interface ButtonProps {
    image: "green" | "yellow"; // Restrict the values of image to 'green' or 'yellow'
