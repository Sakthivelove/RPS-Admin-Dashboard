...

                {
                    sidebarActive ?
                        <div className="w-full my-[1rem]">
                            <button className="capitalize bg-[#45F882] rounded-[5px] w-full px-[28px] py-[10px] poppins-bold" onClick={() => navigate("/create-new-admin-tournament")}>Create Admin Tournament</button>
                        </div>
                        :
